...
class Ui_Form(QObject):
    def setupUi(self, Form):
        ...
        self.addHookCollectionPushButton.clicked.connect(self.addHookCollectionPushButtonClicked)
        ...
        # self.hookCollectionPropertiesTableView has no signals to connect to, TODO implement Tableview
    ...
    @pyqtSlot( )
    def addHookCollectionPushButtonClicked( self ):
        self.label.setText("addHookCollectionPushButtonClicked")
