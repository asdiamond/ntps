...
# from ..HookCollectionSubsystem.HookCollectionManager import *
# from ..HookSubsystem.HookManager import *


class Hook_Ui_Form(QObject):
    def setupUi(self, Form):
        #Hook Collection Setup
        self.hookData = None
    ...
    def savePushButtonClicked( self ):
        name = self.hookNameLineEdit.text()
        path = self.hookPathLineEdit.text()
        description = self.descriptionLineEdit.text()
        self.hookData = [path, name, description]
